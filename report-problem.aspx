     ...
     <!--  page-wrapper -->
          <div id="page-wrapper">
            ...
            <div class="row">
               ...
               <asp:TextBox ID="Report_Problem_Date" runat="server" class="form-control" placeholder="Enter the ID"></asp:TextBox>
            
              </div>
             <asp:RequiredFieldValidator runat="server" ControlToValidate="Report_Problem_Date" CssClass="text-danger" ErrorMessage="ID field is required." />
                          ...
                          <div class="col-lg-6">
                                ...
                                <br />
                                      ...
                                      <asp:Button ID="Report_Problem_sub" type="submit" runat="server" Text="Submit" class="btn btn-primary"/>
